...
BODCbiometrics <- c ('http://vocab.nerc.ac.uk/collection/P01/current/LSTAGE01/', 'http://vocab.nerc.ac.uk/collection/P01/current/OBSINDLX/',
                      ...
                      ,'http://vocab.nerc.ac.uk/collection/P01/current/ENTSEX01/', 'http://vocab.nerc.ac.uk/collection/P01/current/SL01XX01/' ) #create a list of the measurementtypeIDs to be taken into account when checking the occurrence table for duplicates 
